class MessagesController < ApplicationController
  ...
  def create
    ...
    if @message.save
      ...
      receiver = conversation.sender.id == current_user.id ?
      ...
      redirect_to request.referrer, notice: "Cannot send the message..."
    end
  ...
  def render_message(message, user)
    self.render_to_string partial: 'conversations/message',
                          locals: { m: message, user: user }
  end
